aws ecr get-login-password --region ap-southeast-1 --profile self | docker login --username AWS --password-stdin 047590809543.dkr.ecr.ap-southeast-1.amazonaws.com
